    ...
    <div className="login">
      <div className="login-art" aria-hidden="true">
        ...
        <div className="login-art-body">
          ...
          <div className="login-art-headline">Элегантное управление<br />доступом</div>
          <div className="login-art-intro">
            <p className="login-art-lead">
              Персональное закрытое приложение для жителей и персонала — ваш ключ к безупречному сервису.
            </p>
          ...
          <ul className="login-art-features">
            ...
            <li className="login-art-feature">
              <div className="login-art-feature-icon"><AppIcon name="bell" /></div>
              <div>
            ...
            <li className="login-art-feature">
              <div className="login-art-feature-icon"><AppIcon name="file" /></div>
              <div>
      ...
      <div className="login-panel">
        <div className="login-form">
          ...
          {isDemoMode() && (
            <div className="field-warn" role="status" aria-live="polite">
              Демо-режим: приватная сессия включена по умолчанию и не сохраняет данные между перезапусками. Постоянное хранение включайте только вручную.
            </div>
          )}
