...
describe('authProvider', () => {
  test('sendOtp → POST /api/v1/auth/send-otp', async () => {
  ...
  test('verifyOtp → POST /api/v1/auth/verify-otp, возвращает user', async () => {
  ...
  test('logout → POST /api/v1/auth/logout', async () => {
    apiClient.post.mockResolvedValueOnce({});
...
describe('chatProvider', () => {
  test('getMessages без параметров → GET /api/v1/chat/messages', async () => {
  ...
  test('sendMessage → POST /api/v1/chat/messages', async () => {
  ...
  test('updateMessage → PATCH /api/v1/chat/messages/:id', async () => {
  ...
  test('deleteMessage → DELETE /api/v1/chat/messages/:id', async () => {
  ...
  test('markSeen → POST /api/v1/chat/seen', async () => {
    apiClient.post.mockResolvedValueOnce({});
...
describe('requestsProvider', () => {
  ...
  test('update → PATCH /api/v1/requests/:id', async () => {
  ...
  test('delete → DELETE /api/v1/requests/:id', async () => {
    apiClient.delete.mockResolvedValueOnce({ ok: true });
...
describe('usersProvider', () => {
  ...
  test('delete → DELETE /api/v1/users/:uid', async () => {
    apiClient.delete.mockResolvedValueOnce({ ok: true });
...
describe('permsProvider', () => {
  test('getPerms → GET /api/v1/perms/:uid', async () => {
  ...
  test('savePerms → POST /api/v1/perms/batch (object format: atomic batch save)', async () => {
  ...
  test('savePerms → POST /api/v1/perms (legacy flat array format)', async () => {
...
describe('blacklistProvider', () => {
  ...
  test('remove → DELETE /api/v1/blacklist/:id', async () => {
    apiClient.delete.mockResolvedValueOnce({ ok: true });
...
describe('createBackendProvider', () => {
  ...
  test('admin.saveUserEverywhere вызывает PATCH /api/v1/users/:uid', async () => {
    const p = createBackendProvider();
    apiClient.patch.mockResolvedValueOnce({ uid: 'u1' });
  ...
  test('admin.removeUserEverywhere вызывает DELETE /api/v1/users/:uid', async () => {
    const p = createBackendProvider();
    apiClient.delete.mockResolvedValueOnce({ ok: true });
