...
| Methods without production UI usage | 93 |
...
1. Property directory mutations: staff, contractors, memberships, residents, units, and imports.
2. Request lifecycle UI gaps: standalone request create/update/delete, attachment create, rating, and emergency queue visibility.
3. Access topology/policy edits: update/deactivate/evaluate flows beyond create/deactivate baseline.
4. Guard visit and visit-log parity: list/detail/create/verify surfaces for security operations.
