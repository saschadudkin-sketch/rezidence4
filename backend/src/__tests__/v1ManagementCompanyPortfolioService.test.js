      ...
      if (opts.propertyId === alpha.id) {
        return dashboard({
          ...
          access: {
            ...
            trusted_visitors_active: 5,
            trusted_visitor_passes_created: 3,
            skud_failed_events: 2,
            skud_manual_control_count: 1,
            by_access_point: [{ access_point_id: 'point-a', name: 'КПП A', allow_count: 20, denial_count: 2, total: 22 }],
            deny_reasons: [{ reason: 'expired_pass', total: 2 }],
            peak_traffic_windows: [{ window_start: '2026-05-16T08:00:00.000Z', total: 12 }],
            manual_overrides_by_type: [{ override_type: 'manual_admit', total: 4 }],
            offline_replay_by_status: [{ replay_status: 'accepted', total: 1 }],
          },
          incidents: {
            open: 2,
            investigating: 1,
      ...
      return dashboard({
        ...
        access: {
          ...
          requests_rejected: 1,
            ...
            offline_replay_count: 3,
            trusted_visitors_active: 2,
            trusted_visitor_passes_created: 1,
            skud_failed_events: 1,
            skud_manual_control_count: 2,
            by_access_point: [{ access_point_id: 'point-b', name: 'КПП B', allow_count: 5, denial_count: 1, total: 6 }],
            deny_reasons: [{ reason: 'manual_deny', total: 1 }],
            peak_traffic_windows: [{ window_start: '2026-05-16T09:00:00.000Z', total: 4 }],
            manual_overrides_by_type: [{ override_type: 'manual_deny', total: 2 }],
            offline_replay_by_status: [{ replay_status: 'duplicate', total: 3 }],
          },
        incidents: {
          open: 1,
          investigating: 0,
