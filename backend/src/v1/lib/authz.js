...
const CAPABILITIES = Object.freeze({
  ...
  'hardware.device.read': spec(accessOperators),
  'hardware.device.write': spec(admin),
  'hardware.manual_control.execute': spec(accessOperators),
  'erp.exchange.read': spec(admin),
  'erp.exchange.write': spec(admin),
  'erp.exchange.import': spec(admin),
  'erp.exchange.export': spec(admin),
  'gis_oss.readiness.read': spec(admin),
  'gis_oss.readiness.export': spec(admin),
