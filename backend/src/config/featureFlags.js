...
const FEATURE_FLAGS = {
  ...
  trusted_visitors: {
    ...
    description: 'Resident-owned templates for frequent visitors with audited pass creation',
    category: 'access',
  },
  pin_credentials: {
    default: false,
  ...
  public_pass_v1: {
    ...
    description: 'Public-safe v1 pass lookup backed by passes and pass_credentials',
    category: 'access',
  },
  security_workspace_enriched: {
    default: false,
    label: 'Расширенное рабочее место охраны',
    description: 'Guard/security workspace with bootstrap, search, manual decisions and offline replay',
    category: 'access',
  },
