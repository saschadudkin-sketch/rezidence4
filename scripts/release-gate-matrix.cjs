...
const RELEASE_GATES = [
  ...
  },
  {
    ...
    scripts: ['backend:test', 'tenant:preflight:current'],
    evidence: [
      ...
      'backend/src/__tests__/v1VideoEvidenceRoute.test.js',
      'backend/src/__tests__/v1ErpExchangeRoute.test.js',
      'backend/src/__tests__/v1LegacyUtilitiesFrozen.test.js',
    ],
  },
  {
    id: 'expansion-layer',
